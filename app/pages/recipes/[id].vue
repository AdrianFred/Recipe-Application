...
useSeoMeta({
  ...
  ogUrl: `http://localhost:3000/recipes/${recipe.value?.id}`,
...
<template>
  <div class="flex flex-col max-w-screen-lg container py-20">
    ...
    <!-- Image -->
    <NuxtImg :src="recipe?.image" densities="x1" sizes="xs:100vw sm:100vw md:100vw lg:100vw" class="w-full max-h-[500px] object-cover rounded-md shadow-sm mb-12" alt="" />
